<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病床类别" prop="bingchuangleibie">
          <el-input v-model="ruleForm.bingchuangleibie" 
              placeholder="病床类别" clearable  :readonly="ro.bingchuangleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病床类别" prop="bingchuangleibie">
              <el-input v-model="ruleForm.bingchuangleibie" 
                placeholder="病床类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bingchuangleibie'){
            this.ruleForm.bingchuangleibie = obj[o];
	    this.ro.bingchuangleibie = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `bingchuangleibie/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bingchuangleibieCrossAddOrUpdateFlag = false;
                  this.parent.search();
